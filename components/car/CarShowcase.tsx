...
export default function CarShowcase({ car, onNext, onPrev, onImageClick }: CarShowcaseProps) {
  ...
  return (
    <div
      ...
      onClick={onImageClick}
      style={{
        borderColor: hovered ? 'rgba(0,168,232,0.3)' : 'rgba(0,168,232,0.12)',
        boxShadow: hovered
    ...
    >
      <style jsx>{`
        ...
        .scan { animation: scanline 4s linear infinite; opacity: 0; }
        .group:hover .scan { opacity: 1; }
      `}</style>
      ...
      <div className="relative" style={{ height: 'clamp(280px, 45vw, 520px)' }}>
        <Image
          ...
          style={{ transition: 'transform 0.7s ease', transform: hovered ? 'scale(1.04)' : 'scale(1)' }}
        />

        {/* Gradient overlays */}
        <div className="absolute inset-0" style={{ background: 'linear-gradient(0deg, #080A0E 0%, rgba(8,10,14,0.5) 35%, transparent 65%)' }} />
        <div className="absolute inset-0" style={{ background: 'linear-gradient(90deg, rgba(8,10,14,0.75) 0%, transparent 50%)' }} />

        {/* Scanline effect */}
        <div className="scan absolute inset-x-0 h-24" style={{ background: 'linear-gradient(0deg, transparent, rgba(0,168,232,0.06), transparent)', top: 0 }} />
        ...
        {[
          ...
          <div key={i} className={`absolute ${corner} w-6 h-6 z-10`} style={{
        ...
        <div className="absolute top-5 left-5 flex gap-2 z-10">
          <span style={{
            ...
            fontSize: 11, letterSpacing: '0.25em', textTransform: 'uppercase', color: '#E8ECF0',
          }}>
            {car.type}
          </span>
          {car.status === "New" && (
            <span style={{
              background: '#00A8E8', borderRadius: 3, padding: '4px 12px',
              fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700,
              fontSize: 11, letterSpacing: '0.25em', textTransform: 'uppercase', color: '#fff',
        ...
        <div className="absolute top-5 right-5 z-10 flex items-center gap-2"
          style={{
            background: 'rgba(8,10,14,0.75)', backdropFilter: 'blur(8px)',
            border: '1px solid rgba(0,168,232,0.2)', borderRadius: 3, padding: '6px 14px',
            opacity: hovered ? 1 : 0.6, transition: 'opacity 0.3s',
          }}>
          <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 600, letterSpacing: '0.2em', textTransform: 'uppercase', color: '#00A8E8' }}>
            Explore
          </span>
        ...
        <div className="absolute inset-x-0 bottom-0 px-6 pb-6 z-10">
          <p style={{
            fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 600,
            fontSize: 11, letterSpacing: '0.3em', textTransform: 'uppercase', color: '#00A8E8', marginBottom: 4,
          }}>
            {car.description}
          </p>
          <h2 style={{
            fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 900,
            fontSize: 'clamp(36px, 7vw, 64px)', textTransform: 'uppercase',
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                style={{
                  ...
                  background: 'rgba(8,10,14,0.8)', backdropFilter: 'blur(8px)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  color: '#fff', cursor: 'pointer', transition: 'border-color 0.2s, background 0.2s',
                }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  background: 'rgba(0,168,232,0.1)', backdropFilter: 'blur(8px)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  color: '#00A8E8', cursor: 'pointer', transition: 'all 0.2s',
            ...
            <button
              ...
              style={{
                background: '#00A8E8', color: '#fff', border: 'none', borderRadius: 4,
                padding: '11px 24px',
                fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700,
                fontSize: 13, letterSpacing: '0.18em', textTransform: 'uppercase', cursor: 'pointer',
