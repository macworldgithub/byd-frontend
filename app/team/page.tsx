...
export default function LeadCapturePage() {
  ...
  const validatePersonal = () => {
    ...
    if (!form.postcode.trim() || !/^\d{4}$/.test(form.postcode)) e.postcode = "4-digit postcode required";
    return e;
  };
  ...
  const handleSubmit = async () => {
    if (!form.consent) { setErrors({ consent: "Please accept to continue" }); return; }

    setIsSubmitting(true);
    setSubmitError(null);

    // Map internal values to API-expected format
    const modelLabel = BYD_MODELS.find((m) => m.value === form.model)?.label ?? form.model;
    ...
    const payload = {
      ...
      contactPreference: form.contactPreference.charAt(0).toUpperCase() + form.contactPreference.slice(1),
    ...
    <div style={{ width: "100%", position: "relative" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: "linear-gradient(0deg, #080A0E 0%, rgba(8,10,14,0.55) 45%, rgba(8,10,14,0.1) 100%)",
        }} />
        <div style={{
          position: "absolute", inset: 0,
        ...
        <div style={{
          ...
          fontWeight: 900, fontSize: 20, letterSpacing: "0.22em", color: "white",
        }}>BYD</div>
      ...
      <div className="section-content" style={{ paddingTop: 24 }}>
        ...
        <p style={{
          ...
          Join thousands driving Australia's favourite new energy vehicles. Instant access to latest offers on{" "}
          <span style={{ color: "#00A8E8", fontWeight: 600 }}>Atto 3, Seal, Sealion, Dolphin &amp; more.</span>
        </p>
        ...
        <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 22 }}>
          {["Atto 3", "Seal", "Dolphin", "Sealion 6", "Sealion 7", "Shark 6"].map((m) => (
            <span key={m} style={{
              fontFamily: "'Barlow Condensed', sans-serif",
              fontWeight: 600,
              fontSize: 11,
        ...
        <button
          ...
          onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 6px 32px rgba(0,168,232,0.6)"; }}
          onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 4px 24px rgba(0,168,232,0.4)"; }}
        >
  ...
  const renderPersonal = () => (
    <div className="section-content" style={{ paddingTop: 28 }}>
      ...
      <h2 className="section-title text-center mb-2" style={{ fontSize: "clamp(24px,5vw,40px)", color: "#E8ECF0" }}>
        Your Details
      </h2>
      <p style={{
        fontFamily: "'Barlow', sans-serif",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {TIMELINES.map((t) => (
            <button
              ...
              style={{
                padding: "11px 16px",
                background: form.timeline === t.value
                  ? "rgba(0,168,232,0.12)"
                  : "rgba(255,255,255,0.03)",
            ...
            >
              <div style={{
                ...
                {form.timeline === t.value && (
                  <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#00A8E8" }} />
                )}
              </div>
              <span style={{
                fontFamily: "'Barlow', sans-serif",
          ...
          {(["phone", "email"] as const).map((pref) => (
            <button
              ...
              style={{
                flex: 1,
                padding: "10px",
                background: form.contactPreference === pref
                  ? "rgba(0,168,232,0.12)"
                  : "rgba(255,255,255,0.03)",
  ...
  const renderConfirm = () => {
    ...
    if (submitted) {
      return (
        <div className="section-content" style={{ paddingTop: 40, textAlign: "center" }}>
          <div style={{
            width: 72,
            height: 72,
            borderRadius: "50%",
            ...
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#00A8E8" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
          ...
          <p style={{
            ...
            Thanks, <strong style={{ color: "#E8ECF0" }}>{form.firstName}</strong>. Our BYD team will be in touch shortly with your personalised offer for the <strong style={{ color: "#00A8E8" }}>{modelLabel}</strong>.
          </p>
      ...
      <div className="section-content" style={{ paddingTop: 28 }}>
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <textarea
            ...
            onFocus={(e) => { e.currentTarget.style.borderColor = "rgba(0,168,232,0.4)"; }}
        ...
        <div
          ...
          style={{
            ...
            padding: "14px 14px",
            background: form.consent ? "rgba(0,168,232,0.06)" : "rgba(255,255,255,0.02)",
        ...
        >
          ...
          <p style={{
            ...
            I agree to receive communications from BYD and authorised dealers about new vehicles, offers and test drives.{" "}
        ...
        <button
          ...
          style={{
            ...
            boxShadow: isSubmitting ? "none" : "0 4px 20px rgba(0,168,232,0.35)",
            transition: "all 0.2s",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
        ...
        <div style={{
          ...
          <span style={{
            ...
            Your information is secure and only used to contact you about BYD vehicles.
          </span>
        </div>
    ...
    >
      <style jsx global>{`
        ...
        * { box-sizing: border-box; }
        ...
        textarea::placeholder, input::placeholder { color: #3D4450; }
...
function FieldLabel({ label, required }: { label: string; required?: boolean }) {
  return (
    <p style={{
      ...
      {label}{required && <span style={{ color: "#00A8E8", marginLeft: 2 }}>*</span>}
    </p>
  );
}
  ...
  return (
    <>
      <input
        ...
        onFocus={(e) => { e.currentTarget.style.borderColor = error ? "rgba(239,68,68,0.5)" : "rgba(0,168,232,0.4)"; }}
